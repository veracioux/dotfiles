...
#+begin_src fish
  ...
  _abbr            -g OC    "cd ~/.empty; bun ~/proj/contrib/opencode/packages/opencode/src/index.ts"
  _abbr            -g OCd   "cd ~/.empty; bun --inspect-wait=localhost:6499/opencode ~/proj/contrib/opencode/packages/opencode/src/index.ts"
