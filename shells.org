...
#+begin_src fish
  ...
  conditional_abbr -g dc   'docker-compose'
  conditional_abbr -g dcub 'docker-compose up --build'
  conditional_abbr -g dce  'docker-compose exec'
  conditional_abbr -g dcd  'docker-compose down'
#+end_src
**** Pass
#+begin_src fish
  # Pass
