#+TITLE: Scripts
#+PROPERTY: header-args :comments headline :mkdirp yes :tangle-mode (identity #o744) :results silent
...
#+begin_src bash :tangle (haris/tangle-home ".local/lib/dmenu/quickmenu")
  ...
  case "$choice" in
      "Algorithms")
          zathura ~/data/literature/prog/"Thomas H. Cormen - Introduction to Algorithms (2022).pdf"
          ;;
      "Bullshit Jobs")
          zathura ~/data/literature/world/"David Graeber - Bullshit Jobs_ A Theory-Simon & Schuster (2018).epub"
          ;;
      "MONEY - Tony Robbins")
          zathura ~/data/literature/finance/"Tony Robbins - MONEY Master the Game - 7 Simple Steps to Financial Freedom (2014).epub"
          ;;
      "I will teach you to be rich - Ramit Sethi")
          zathura ~/data/literature/finance/"Ramit Sethi - I Will Teach You to Be Rich, Second Edition (2019).epub"
          ;;
  esac
#+end_src
