...
** =tangle=
#+NAME: tangle
#+begin_src emacs-lisp :tangle (haris/tangle-home ".local/bin/tangle") :noweb yes
...
#+begin_src shell :tangle (haris/tangle-home ".haris/bootstrap/tangle.sh")
  <<tangle>>
#+end_src
...
#+begin_src emacs-lisp :results none
  ...
  (load-file "~/.haris/bootstrap/lib.el")
...
Because this script is needed for bootstrapping my dotfiles on a new system, I
also tangle it to a standalone destination that I also keep under version control.
#+begin_src shell :tangle (haris/tangle-home ".haris/bootstrap/tangle-all.sh")
  <<tangle-all>>
#+end_src
** TODO =bootstrap=
- Soon to be obsolete
