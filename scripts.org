...
#+end_src
** =clipctl=                                                       :wrapper:
#+begin_src bash :tangle (haris/tangle-home ".local/bin/clipctl")
  set -e
...
#+end_src
*** Completions
#+begin_src fish :tangle (haris/tangle-home ".config/fish/completions/clipctl.fish")
...
#+begin_src bash :tangle (haris/tangle-home ".local/bin/docker-compose")
...
#+end_src
** =printarg=
#+begin_src bash :tangle (haris/tangle-home ".local/bin/printarg")
...
#+end_src
** =trim=
#+begin_src shell :tangle (haris/tangle-home ".local/bin/trim")
...
#+end_src
** =delayed-command=
#+begin_src bash :tangle (haris/tangle-home ".local/bin/delayed-command")
  sleep "$1"
  exec "${@:2}"
#+end_src
*** Completions
#+begin_src fish :tangle (haris/tangle-home ".config/fish/completions/delayed-command.fish")
...
#+end_src
** =mosquitto_sub_yq=
#+begin_src bash :tangle (haris/tangle-home ".local/bin/mosquitto_sub_yq")
  mosquitto_sub \
      -F '{"topic": "%t",\n"body": %p}' \
      "$@" |
      while :; do
...
#+end_src
*** Completions
#+begin_src fish :tangle (haris/tangle-home ".config/fish/completions/mosquitto_sub_yq.fish")
  complete -c mosquitto_sub_yq --wraps mosquitto_sub
#+end_src
** =mosquitto_sub_jq=
#+begin_src bash :tangle (haris/tangle-home ".local/bin/mosquitto_sub_jq")
  mosquitto_sub \
      -F '{"topic": "%t",\n"body": %p}' \
      "$@" |
      while :; do
...
#+end_src
*** Completions
#+begin_src fish :tangle (haris/tangle-home ".config/fish/completions/mosquitto_sub_jq.fish")
...
command there.
#+begin_src bash :tangle (haris/tangle-home ".local/bin/@gh")
  if [ "$#" -lt 3 ]; then
  ...
  tmpdir="$(mktemp -d ~/.cache/haris/tmp-repos/XXXXXXXX)"
  git clone --reference ~/.cache/haris/tmp-commits --depth 1 --no-checkout "$1" "$tmpdir"
  cd "$tmpdir" || exit 1
  git fetch origin "$2"
...
#+end_src
*** =code-oss=
#+begin_src shell :tangle (haris/tangle-home ".local/bin/code-oss")
  code "$@"
#+end_src
* Helper code
