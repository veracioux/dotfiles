...
#+begin_src shell :tangle (haris/tangle-home ".local/bin/dmenu")
  timeout --foreground 10s alternative-command dmenu -b -f -i -h 25 \
...
#+end_src
** =dragon=
#+begin_src shell :tangle (haris/tangle-home ".local/bin/dragon")
  set -- --on-top --thumb-size 32 "$@"

  if which -s dragon-drag-and-drop; then
