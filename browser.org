...
#+begin_src shell
  ...
  # Yank basename from URL
  bind yb composite js new URL(location.href).pathname.split('/').filter(x => x).pop() | clipboard yank
  bind yp composite js new URL(location.href).pathname.split('/').filter(x => x).pop() | js -p `gh pr checkout ${JS_ARG}` | clipboard yank
  ...
  bind ,0 js let u = new URL(location.href); u.searchParams.set("authuser", "0"); location.href = u.toString()
  bind ,1 js let u = new URL(location.href); u.searchParams.set("authuser", "1"); location.href = u.toString()
  bind ,2 js let u = new URL(location.href); u.searchParams.set("authuser", "2"); location.href = u.toString()
  bind ,3 js let u = new URL(location.href); u.searchParams.set("authuser", "3"); location.href = u.toString()
  bind ,4 js let u = new URL(location.href); u.searchParams.set("authuser", "4"); location.href = u.toString()
  bind ,5 js let u = new URL(location.href); u.searchParams.set("authuser", "5"); location.href = u.toString()
  bind ,6 js let u = new URL(location.href); u.searchParams.set("authuser", "6"); location.href = u.toString()
  bind ,7 js let u = new URL(location.href); u.searchParams.set("authuser", "7"); location.href = u.toString()
  bind ,8 js let u = new URL(location.href); u.searchParams.set("authuser", "8"); location.href = u.toString()
  bind ,9 js let u = new URL(location.href); u.searchParams.set("authuser", "9"); location.href = u.toString()
