...
* IdeaVim
:PROPERTIES:
:header-args+: :tangle ~/.ideavimrc
:END:
I use Intellimacs which is a Spacemacs emulation layer. It needs to be installed
as per [[https://github.com/marcoieni/intellimacs?tab=readme-ov-file#installation][these instructions]].
** Intellimacs config
