#+TITLE: Emacs Config
#+PROPERTY: header-args :tangle /tmp/.haris/.emacs.d/haris-config.el
...
** Babel
   #+begin_src emacs-lisp
     ...
     (defun haris/tangle ()
       (interactive)
       (shell-command "rm -rf /tmp/.haris")
       (org-babel-tangle)
       (shell-command "rsync -ru /tmp/.haris/ ~/" t))
...
*** Dependencies
    ...
    #+end_src
* Spacemacs
  #+begin_src emacs-lisp :tangle /tmp/.haris/.spacemacs-init.el
    (setq-default
