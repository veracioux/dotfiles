...
** Applications menu
#+begin_src i3wm-config
  set $mode_apps "Apps | [p]acman [c]lipmenu [e]lement [v]iber [u]nicode"
...
#+NAME: resize-menu
#+begin_src i3wm-config
  set $mode_resize     " resize | [w]idth [h]eight [+] [-] (Shift modifier available) | Presets [0] [1] [2] [3] [4] (Shift to center)"
