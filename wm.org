...
#+begin_src sxhkdrc :tangle (haris/tangle-home ".config/sxhkd/sxhkdrc")
  ...
  mod4 + ISO_Level3_Shift
      o --silent dmenu_run
  mod4 + c
      o --silent dmenu_run config
  mod4 + o
      o --silent dmenu_run open
  mod4 + shift + p
      o --silent dmenu_run passmenu -l 10
  mod4 + ctrl + p
      o --silent dmenu_run otp
  mod4 + q
      o --silent dmenu_run system
  mod4 + ctrl + b
      o --silent dmenu_run books
  mod4 + ctrl + q
      o --silent dmenu_run quickmenu
