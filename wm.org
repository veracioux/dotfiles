...
#+begin_src shell :tangle (haris/tangle-home ".xinitrc-i3")
  ...
  systemctl start --user clipmenud.service      # (ref:clipmenud)
...
#+NAME: resize-menu
#+begin_src i3wm-config
  set $mode_resize     " resize | [w]idth [h]eight [+] [-] (+ Shift variants) | Presets [0/Shift+0] [1] [2] [3] [4] [a] [b] [d]evtools [f]ullHD"
