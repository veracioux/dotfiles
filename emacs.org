...
#+begin_src emacs-lisp
  ...
  (define-key ivy-mode-map (kbd "TAB") #'ivy-insert-current)
#+end_src
#+begin_src emacs-lisp :tangle (haris/tangle-home ".emacs.d/haris/irc.el") :exports none
  <<ivy>>
#+end_src
...
#+begin_src elisp
  ...
  (evil-define-key 'insert org-mode-map (kbd "TAB")
    (lambda () (interactive) (org-tempo-complete-tag)))
...
#+begin_src elisp
  ...
  (defun haris/yas-expand ()
    (interactive)
    (condition-case err
        (yas-next-field)
      (error (yas-expand))))

  (defun haris/company-complete-selection ()
    (interactive)
    (condition-case err
        (yas-expand)
      (error (company-complete-selection))))
  ...
  (evil-define-key 'insert yas-minor-mode-map (kbd "TAB")
    '(menu-item "" haris/yas-expand :filter yas-maybe-expand-abbrev-key-filter))
  ;; so I have to replace company-complete-selection with a custom function
  (define-key company-active-map (kbd "TAB") 'haris/company-complete-selection)
...
** Command log mode
#+begin_src elisp
  (spacemacs/set-leader-keys (kbd "oc") (lambda () (interactive)
