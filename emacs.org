...
#+begin_src elisp
  ...
  ;; Misc
  (eval-after-load 'go-translate
    (lambda () (spacemacs/set-leader-keys "ot" #'gt-do-translate)))
...
#+begin_src elisp
  ...
  (eval-after-load 'org (lambda () (global-org-modern-mode)))
#+end_src
** Agenda
#+begin_src elisp
...
#+begin_src elisp
  ...
  (with-eval-after-load 'haris/ai
    (setq magit-gptcommit-llm-provider haris/ai/model/default))
...
* AI
#+begin_src elisp
  (setq haris/ai/model/openai/o3-mini
        (make-llm-openai :key openai-key :chat-model "o3-mini"))
  (setq haris/ai/model/openai/o4-mini
        (make-llm-openai :key openai-key :chat-model "o4-mini"))

  (setq haris/ai/model/default/name "o3-mini")
  (setq haris/ai/model/default (eval (intern (format "haris/ai/model/openai/%s" haris/ai/model/default/name))))
...
#+begin_src elisp
  ...
  (setq aidermacs-default-model (concat "openai/" haris/ai/model/default/name))
...
#+begin_src elisp
  (setopt ellama-providers
          '(("openai/o3-mini" . (make-llm-openai :chat-model "o3-mini" :key openai-key))))
  (setopt ellama-provider haris/ai/model/openai/o3-mini)
#+end_src
* REPLs in Emacs
** Common settings
#+begin_src elisp
