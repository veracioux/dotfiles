...
#+begin_src elisp
  ...
  (defun haris/projectile-open-claude ()
    (interactive)
    (let ((default-directory (projectile-project-root)))
      (terminal-here '("fish" "-C" "claude"))))
#+end_src
*** Keybindings
#+begin_src elisp
  ...
  (define-key spacemacs-cmds (kbd "p C") 'haris/projectile-open-claude)
#+end_src
