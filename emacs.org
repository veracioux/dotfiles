...
#+begin_src elisp
  ...
  (setq haris/company-backends-yaml-mode haris/company-backends-default)
  (haris/init-company-for-mode 'yaml-mode)

  (setq haris/company-backends-yaml-ts-mode haris/company-backends-default)
  (haris/init-company-for-mode 'yaml-ts-mode)

  (setq haris/company-backends-java-mode haris/company-backends-default)
  (haris/init-company-for-mode 'java-mode)

  (setq haris/company-backends-python-mode haris/company-backends-default)
  (haris/init-company-for-mode 'python-mode)

  (setq haris/company-backends-sql-mode haris/company-backends-default)
  (haris/init-company-for-mode 'sql-mode)

  (setq haris/company-backends-systemd-mode haris/company-backends-default)
  (haris/init-company-for-mode 'systemd-mode)

  (setq haris/company-backends-haris/git-commit-major-mode
        haris/company-backends-default)
  (haris/init-company-for-mode 'haris/git-commit-major-mode)

  (setq haris/company-backends-typescript-mode haris/company-backends-default)
  (haris/init-company-for-mode 'typescript-mode)

  (setq haris/company-backends-emacs-lisp-mode haris/company-backends-default)
  (haris/init-company-for-mode 'emacs-lisp-mode)

  (setq haris/company-backends-lisp-data-mode haris/company-backends-default)
  (haris/init-company-for-mode 'lisp-data-mode)

  (setq haris/company-backends-docker-compose-mode haris/company-backends-default)
  (haris/init-company-for-mode 'docker-compose-mode)

  (setq haris/company-backends-markdown-mode haris/company-backends-default)
  (haris/init-company-for-mode 'markdown-mode)

  ;; TODO: company-edbi seems to be useless
  (setq haris/company-backends-sql-interactive-mode
        '((company-files :with company-yasnippet)
          (company-edbi
           company-semantic
           company-dabbrev-code
           ...
           :with company-yasnippet)
          (company-dabbrev :with company-yasnippet)))
  (haris/init-company-for-mode 'sql-interactive-mode)
#+end_src
