...
#+begin_src bash
  repo_url='https://github.com/veracioux/snippets'
  snippets_dir=~/.emacs.d/private/snippets

  git clone "$repo_url" "$snippets_dir" ||
      echo "Snippets already cloned. Manual setup might be required."
#+end_src
** Theme
...
#+begin_src elisp
  (use-package ivy-rich
    ...
    :config
    (ivy-rich-mode 1)
    (when (not (cl-find 'helpful-callable ivy-rich-display-transformers-list))
