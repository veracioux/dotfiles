...
#+begin_src gitconfig
  [alias]
    ...
    tra = commit --amend --no-edit --reset-author
#+end_src
*** submodule
#+begin_src gitconfig
  [alias]
...
#+begin_src gitignore :tangle ~/.global.gitignore
  .projectile
  .wt*/
  wt*/
  *.bak
...
* Script aliases
** =bak=
#+begin_src shell :tangle ~/.local/bin/git-bak :tangle-mode (eval #o744)
  #!/usr/bin/env sh
...
#+end_src
** =remaster=
#+begin_src shell :tangle ~/.local/bin/git-remaster :tangle-mode (eval #o744)
  #!/usr/bin/env bash
...
** =redate=
#+begin_src shell :tangle ~/.local/bin/git-redate :tangle-mode (eval #o744)
  #!/usr/bin/env sh

  GIT_COMMITTER_DATE="$1" git commit --amend --no-edit --date "$1"
#+end_src
* GitHub CLI
#+begin_src yaml :tangle ~/.config/gh/config.yml
  git_protocol: ssh
  prompt: enabled
  pager:
  aliases:
